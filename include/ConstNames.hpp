...
extern const CN_PROGMEM char CN_EffectChannelMode [];
...
extern const CN_PROGMEM char CN_FlashEnable [];
extern const CN_PROGMEM char CN_FlashMinInt [];
extern const CN_PROGMEM char CN_FlashMaxInt [];
extern const CN_PROGMEM char CN_FlashMinDelay [];
...
extern const CN_PROGMEM char CN_sd_pwr_pin [];
extern const CN_PROGMEM char CN_sd_pwr_on [];
extern const CN_PROGMEM char CN_sd_pwr_dly [];
...
extern const CN_PROGMEM char CN_slashsd [];
extern const CN_PROGMEM char CN_slashsdslash [];
...
extern const CN_PROGMEM char CN_TransCount [];
extern const CN_PROGMEM char CN_TransDelay [];
...
extern const CN_PROGMEM char CN_Version [];
extern const CN_PROGMEM char CN_w [];
