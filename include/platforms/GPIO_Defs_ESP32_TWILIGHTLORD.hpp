...
const OM_OutputPortDefinition_t OM_OutputPortDefinitions[] =
{
    ...
    {OM_PortId_t(4), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_31}},
    {OM_PortId_t(4), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_31}},
    {OM_PortId_t(5), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_32}},
    {OM_PortId_t(5), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_32}},
    {OM_PortId_t(6), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_33}},
    {OM_PortId_t(6), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_33}},
    {OM_PortId_t(7), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_34}},
    {OM_PortId_t(7), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_34}},
    {OM_PortId_t(8), OM_PortType_t::OM_I2C,    {gpio_num_t::GPIO_NUM_5, gpio_num_t::GPIO_NUM_6}},
};
