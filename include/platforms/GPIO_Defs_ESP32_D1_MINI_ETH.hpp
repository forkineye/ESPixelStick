...
const OM_OutputPortDefinition_t OM_OutputPortDefinitions[] =
{
    ...
    {OM_PortId_t(2), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_39}},
    {OM_PortId_t(2), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_39}},
    {OM_PortId_t(3), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_35}},
    {OM_PortId_t(3), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_35}},
    {OM_PortId_t(4), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_33}},
    {OM_PortId_t(4), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_33}},
    {OM_PortId_t(5), OM_PortType_t::OM_I2C,    {gpio_num_t::GPIO_NUM_34, gpio_num_t::GPIO_NUM_9}},
    {OM_PortId_t(6), OM_PortType_t::OM_I2C,    {gpio_num_t::GPIO_NUM_32, gpio_num_t::GPIO_NUM_17, gpio_num_t::GPIO_NUM_39}},
};
