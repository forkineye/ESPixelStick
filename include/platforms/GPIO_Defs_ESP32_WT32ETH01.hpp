...
const OM_OutputPortDefinition_t OM_OutputPortDefinitions[] =
{
    ...
    {OM_PortId_t(4), OM_PortType_t::OM_SERIAL, {gpio_num_t::GPIO_NUM_1}},
    {OM_PortId_t(4), OM_PortType_t::OM_RELAY,  {gpio_num_t::GPIO_NUM_1}},
    {OM_PortId_t(5), OM_PortType_t::OM_I2C,    {gpio_num_t::GPIO_NUM_3, gpio_num_t::GPIO_NUM_17}},
};
