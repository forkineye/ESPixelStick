#pragma once
/*
* GPIO_Defs_ESP32_Solo2go.hpp - Output Management class
*
...
//Output Manager
#define DEFAULT_UART_0_GPIO      gpio_num_t::GPIO_NUM_2

// SPI Output
#define SUPPORT_SPI_OUTPUT
#define DEFAULT_SPI_DATA_GPIO   gpio_num_t::GPIO_NUM_25
#define DEFAULT_SPI_CLOCK_GPIO  gpio_num_t::GPIO_NUM_26
#define DEFAULT_SPI_CS_GPIO     gpio_num_t::GPIO_NUM_27
...
//Power relay output
#define DEFAULT_RELAY_GPIO      gpio_num_t::GPIO_NUM_17
