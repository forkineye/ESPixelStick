    ...
    c_OutputUCS1903 (OutputPortDefinition, outputType)
{
    ...
    ZeroBit = {UCS1903_PIXEL_RMT_TICKS_BIT_0_HIGH, 1, UCS1903_PIXEL_RMT_TICKS_BIT_0_LOW, 0};
    OneBit  = {UCS1903_PIXEL_RMT_TICKS_BIT_1_HIGH, 1, UCS1903_PIXEL_RMT_TICKS_BIT_1_LOW, 0};
