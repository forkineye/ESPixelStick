    ...
    c_OutputUCS8903 (OutputPortDefinition, outputType)
{
    ...
    ZeroBit = {UCS8903_PIXEL_RMT_TICKS_BIT_0_HIGH, 1, UCS8903_PIXEL_RMT_TICKS_BIT_0_LOW, 0};
    OneBit  = {UCS8903_PIXEL_RMT_TICKS_BIT_1_HIGH, 1, UCS8903_PIXEL_RMT_TICKS_BIT_1_LOW, 0};
