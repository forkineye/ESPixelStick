    ...
    c_OutputGS8208 (OutputPortDefinition, outputType)
{
    ...
    ZeroBit = {GS8208_PIXEL_RMT_TICKS_BIT_0_HIGH, 1, GS8208_PIXEL_RMT_TICKS_BIT_0_LOW, 0};
    OneBit  = {GS8208_PIXEL_RMT_TICKS_BIT_1_HIGH, 1, GS8208_PIXEL_RMT_TICKS_BIT_1_LOW, 0};
