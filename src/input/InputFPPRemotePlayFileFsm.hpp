...
/*****************************************************************************/
class fsm_PlayFile_state_Idle : fsm_PlayFile_state
{
public:
...
/*****************************************************************************/
class fsm_PlayFile_state_PlayingFile : fsm_PlayFile_state
{
public:
    virtual void Poll (void);
    virtual void Init (c_InputFPPRemotePlayFile* Parent);
...
/*****************************************************************************/
class fsm_PlayFile_state_Paused : fsm_PlayFile_state
{
public:
    virtual void Poll (void);
    virtual void Init (c_InputFPPRemotePlayFile* Parent);
