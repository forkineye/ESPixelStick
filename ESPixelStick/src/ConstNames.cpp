...
const CN_PROGMEM char CN_admin                    [] = "admin";
...
const CN_PROGMEM char CN_arch                     [] = "arch";
...
const CN_PROGMEM char CN_built                    [] = "built";
...
const CN_PROGMEM char CN_ERROR                    [] = "ERROR";
const CN_PROGMEM char CN_ESP                      [] = "ESP";
...
const CN_PROGMEM char CN_opt                      [] = "opt";
const CN_PROGMEM char CN_options                  [] = "options";
...
const CN_PROGMEM char CN_saved                    [] = "saved";
...
const CN_PROGMEM char CN_set                      [] = "set";
...
const CN_PROGMEM char MN_142                      [] = "Could not open file for writing.";
const CN_PROGMEM char MN_143                      [] = " bytes.";
const CN_PROGMEM char MN_144                      [] = "' not found.";
const CN_PROGMEM char MN_145                      [] = "' too large for buffer. ";
const CN_PROGMEM char MN_146                      [] = " Could not allocate another file handle ";
const CN_PROGMEM char MN_147                      [] = "SD Card Size: ";
const CN_PROGMEM char MN_148                      [] = "ERROR: Failed to allocate memory for the GetListOfSdFiles web request response.";
const CN_PROGMEM char MN_149                      [] = "SdCardPresent";
const CN_PROGMEM char MN_150                      [] = "totalBytes";
const CN_PROGMEM char MN_151                      [] = "System Volume Information";
const CN_PROGMEM char MN_152                      [] = "usedBytes";
const CN_PROGMEM char MN_153                      [] = "> ";
const CN_PROGMEM char MN_154                      [] = " - ";
const CN_PROGMEM char MN_155                      [] = "Could not open '";
const CN_PROGMEM char MN_156                      [] = "' for writting.";
const CN_PROGMEM char MN_157                      [] = "Wrote '";
const CN_PROGMEM char MN_158                      [] = "' ";
const CN_PROGMEM char MN_159                      [] = "ERROR: Cannot find '";
const CN_PROGMEM char MN_160                      [] = "' for reading. File does not exist.";
const CN_PROGMEM char MN_161                      [] = "ERROR: Cannot open '";
const CN_PROGMEM char MN_162                      [] = "ERROR: SD Card: Could not set file read start position";
const CN_PROGMEM char MN_163                      [] = "ReadSdFile::ERROR::Invalid File Handle: ";
const CN_PROGMEM char MN_164                      [] = "CloseSdFile::ERROR::Invalid File Handle: ";
const CN_PROGMEM char MN_165                      [] = "WriteSdFile::ERROR::Invalid File Handle: ";
const CN_PROGMEM char MN_166                      [] = "GetSdFileSize::ERROR::Invalid File Handle: ";
const CN_PROGMEM char MN_167                      [] = "Upload File: '";
const CN_PROGMEM char MN_168                      [] = "' Done (";
const CN_PROGMEM char MN_169                      [] = "s)";
const CN_PROGMEM char MN_170                      [] = "Aborting Previous File Upload For: '";
const CN_PROGMEM char MN_171                      [] = "' Started";
const CN_PROGMEM char MN_172                      [] = "---- Pretty Print: '";
const CN_PROGMEM char MN_173                      [] = "Access-Control-Allow-Origin";
const CN_PROGMEM char MN_174                      [] = "Access-Control-Allow-Headers";
const CN_PROGMEM char MN_175                      [] = "Access-Control-Allow-Methods";
const CN_PROGMEM char MN_176                      [] = "Web server listening on port ";
const CN_PROGMEM char MN_177                      [] = "ERROR: Failed to allocate memory for the GetDeviceOptions web request response.";
const CN_PROGMEM char MN_178                      [] = "-- Ignore binary message --";
const CN_PROGMEM char MN_179                      [] = " onWsEvent() error: Incoming message is too long. ";
const CN_PROGMEM char MN_180                      [] = " WebIO::onWsEvent(): Parse Error: ";
const CN_PROGMEM char MN_181                      [] = "WS client connect - ";
const CN_PROGMEM char MN_182                      [] = "WS client disconnect - ";
const CN_PROGMEM char MN_183                      [] = "** WS PONG **";
const CN_PROGMEM char MN_184                      [] = "** WS ERROR **";
const CN_PROGMEM char MN_185                      [] = "ERROR: Unhandled request: ";
const CN_PROGMEM char MN_186                      [] = "{\"Error\":Error";
const CN_PROGMEM char MN_187                      [] = "realflashsize";
const CN_PROGMEM char MN_188                      [] = "flashchipid";
const CN_PROGMEM char MN_189                      [] = "freeheap";
const CN_PROGMEM char MN_190                      [] = "SDinstalled";
const CN_PROGMEM char MN_191                      [] = "DiscardedRxData";
const CN_PROGMEM char MN_192                      [] = "V Error";
const CN_PROGMEM char MN_193                      [] = "ERROR: Unsupported Web command V";
const CN_PROGMEM char MN_194                      [] = "G2{\"version\": \"";
const CN_PROGMEM char MN_195                      [] = "G Error";
const CN_PROGMEM char MN_196                      [] = "ERROR: Unsupported Web command G";
const CN_PROGMEM char MN_197                      [] = "ERROR: Unhandled cmd";
const CN_PROGMEM char MN_198                      [] = "{\"cmd\":\"Error\"}";
const CN_PROGMEM char MN_199                      [] = "{\"cmd\":\"OK\"}";
const CN_PROGMEM char MN_200                      [] = "{\"get\":";
const CN_PROGMEM char MN_201                      [] = "{\"cmd\":\"TIME_SET\"}";
const CN_PROGMEM char MN_202                      [] = "{\"opt\":";
const CN_PROGMEM char MN_203                      [] = "\"ERROR\": \"File List Too Long\"";
const CN_PROGMEM char MN_204                      [] = "ERROR: Unhandled Get Request";
const CN_PROGMEM char MN_205                      [] = "\"ERROR\": \"Request Not Supported\"";
const CN_PROGMEM char MN_206                      [] = " ERROR: Undhandled Set request type. ";
const CN_PROGMEM char MN_207                      [] = "time_t";
const CN_PROGMEM char MN_208                      [] = "{\"OK\" : true}";
const CN_PROGMEM char MN_209                      [] = "ERROR: Unhandled 'opt' Request: ";
const CN_PROGMEM char MN_210                      [] = "{\"cmd\": { \"delete\": ";
const CN_PROGMEM char MN_211                      [] = "* Unsupported Delete command: ";
const CN_PROGMEM char MN_212                      [] = "Page Not found";
const CN_PROGMEM char MN_213                      [] = "Upload Started: ";
const CN_PROGMEM char MN_214                      [] = " UPDATE ERROR: ";
const CN_PROGMEM char MN_215                      [] = "Update Finished: ";
const CN_PROGMEM char MN_216                      [] = "Ethernet Reset has been requested";
const CN_PROGMEM char MN_217                      [] = "";
const CN_PROGMEM char MN_218                      [] = "";
const CN_PROGMEM char MN_219                      [] = "";
const CN_PROGMEM char MN_220                      [] = "";
