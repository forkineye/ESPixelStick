...
static const PROGMEM RmtBitDefinitions[] =
    {
        ...
        {{UCS8903_PIXEL_RMT_TICKS_BIT_0_HIGH, 1, UCS8903_PIXEL_RMT_TICKS_BIT_0_LOW, 0}, Rdbit_t::RMT_DATA_BIT_ZERO_ID},
        {{UCS8903_PIXEL_RMT_TICKS_BIT_1_HIGH, 1, UCS8903_PIXEL_RMT_TICKS_BIT_1_LOW, 0}, Rdbit_t::RMT_DATA_BIT_ONE_ID},
        {{UCS8903_PIXEL_RMT_TICKS_IDLE / 10, 0, UCS8903_PIXEL_RMT_TICKS_IDLE / 10, 1}, Rdbit_t::RMT_INTERFRAME_GAP_ID},
