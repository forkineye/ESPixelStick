...
static const PROGMEM RmtBitDefinitions[] =
    {
        ...
        {{WS2811_PIXEL_RMT_TICKS_BIT_0_HIGH, 1, WS2811_PIXEL_RMT_TICKS_BIT_0_LOW, 0}, Rdbit_t::RMT_DATA_BIT_ZERO_ID},
        {{WS2811_PIXEL_RMT_TICKS_BIT_1_HIGH, 1, WS2811_PIXEL_RMT_TICKS_BIT_1_LOW, 0}, Rdbit_t::RMT_DATA_BIT_ONE_ID},
        {{WS2811_PIXEL_RMT_TICKS_IDLE / 12, 0, WS2811_PIXEL_RMT_TICKS_IDLE / 12, 0}, Rdbit_t::RMT_INTERFRAME_GAP_ID},
        {{2, 1, 2, 1}, Rdbit_t::RMT_STARTBIT_ID},
