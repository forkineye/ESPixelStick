...
static const PROGMEM RmtBitDefinitions[] =
    {
        ...
        {{GS8208_PIXEL_RMT_TICKS_BIT_0_HIGH, 1, GS8208_PIXEL_RMT_TICKS_BIT_0_LOW, 0}, Rdbit_t::RMT_DATA_BIT_ZERO_ID},
        {{GS8208_PIXEL_RMT_TICKS_BIT_1_HIGH, 1, GS8208_PIXEL_RMT_TICKS_BIT_1_LOW, 0}, Rdbit_t::RMT_DATA_BIT_ONE_ID},
        {{2,                                 0, 2,                                1}, Rdbit_t::RMT_STARTBIT_ID},
